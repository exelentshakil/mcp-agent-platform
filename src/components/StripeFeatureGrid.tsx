...
const FEATURES: FeatureItem[] = [
  {
    ...
    description: 'Integrate existing and custom MCP servers using stdio and SSE transports to allow AI agents to safely read schemas and execute actions.',
    linkText: 'View tool discovery & workflow',
    action: 'pipeline',
  },
  {
    id: 'certifications',
    icon: Users,
    title: 'Agentic function calling & RBAC.',
    description: 'Design robust tool-calling loops with OpenAI function calling, structured outputs, prompt engineering, and strict human permission gates.',
    linkText: 'View security & permission rules',
    action: 'governance',
  },
  {
    id: 'retainers',
    ...
    description: 'Build enterprise SaaS functionality with React/Next.js 15, NestJS microservices, TypeScript, PostgreSQL databases, and Inngest event queues.',
    linkText: 'View architecture & execution logs',
    action: 'logs',
  },
];
        ...
        <div className="max-w-3xl mb-10">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-[-0.02em] text-[var(--color-text-primary)]">
            ...
            <span className="text-[var(--color-text-secondary)] opacity-75 font-normal">
              Empowering AI agents to interact with real APIs, databases, and microservices through Model Context Protocol.
            </span>
          </h2>
        </div>
